...
public class Pokemon {
    ...
    private Pokedex.PokedexEntry pokemonData; // The static pokemon data from the Pokedex
    ...
    public Pokemon(int i, int minLvl, int maxLvl, Pokedex.PokedexEntry p, Naturedex n) {
        pokemonData = p;
        id          = i;
